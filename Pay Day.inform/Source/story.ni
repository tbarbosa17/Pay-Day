...
To say exit list: 
	...
	repeat with way running through directions: 
		...
		[From get that cat by Douglas Kiang.][exits on left side status bar]
...
The description of player is "You are stylishly dressed in all black. but you are missing your apron!"

Floor is a room. "You are in a clean, open room with various coffee machines and aparatuses. Your co worker, Patrick, stands by the register in the room.The lobby is to the west and the cold room is to the east."
...
Beans is a thing. Beans is on counter. "The readied espresso beans sit waiting to be used on the counter." The description of beans is "A silver five-pound bag of espresso beans." Understand "espresso beans" as beans.
...
[this lets different wording be used for combining.]
...
{latte, pumpkin spice}			psl
 [taken from assassin.]
[carries out combining action]


Lobby is a room. Lobby is west of Floor. "The lobby is filled with chairs, tables, and a condiment bar. The bathroom is to the south, The patio is to the west and the floor is to the east. "
...
Bathroom is a room. Bathroom is south of Lobby. The description of bathroom is "A clean well lit room with a toilet and a sink. Nothing seems important here. The lobby is to the north."
...
Patio is a room. Patio is west of Lobby. The description of Patio is "A nice veranda running along the side of the building. There are some wicker chairs and metal tables under the awning. Nothing seems important here. The dump is to the north and the lobby is to the east."
...
Dump is a room. Dump is north of Patio. The description of Dump is "There is a dumpster here. Nothing seems important here. The patio is to the south."
...
cold room is a room. cold room is east of floor. The description of cold room is "This small room only hold an ice machine in the corner. Nothing seems important here. The floor is to the west and back storage is to the north."
...
Instead of opening icemachine:
	say "There is a lot of ice in here.";
	now icemachine is open.



Back storage is a room. Back storage is north of cold room. "Someone hasn't been ordering new ingredients! The shelves are completely empty, and there is only a small cabinet in the corner that could possibly hold something useful. The cold room is to the south and the break room is to the east."
...
Break room is a room. Break room is east of back storage. "The familiar space has a desk, and a rack in the corner. There is a lone apron hanging in the corner on the coat rack. There seems to be a post-it with writing on the desk. back storage is to the west and dish room is to the south."
...
Instead of reading Post-it:
	say "The small orange post-it reads: Heard you needed your paycheck, so I looked into changing the safe code. There should be a man coming in around 1:15 to change the code. His name is Cole. I promised him a PUMPKIN SPICE LATTE on the house, so make sure it is ready for him!"
...
Rack is a thing. rack is undescribed. The description of rack is "Just an ordinary coat rack." [sometimes description doesn't work.]
Desk is a thing. Desk is in break room. Desk is undescribed. The description of desk is "Just an ordinary desk."

Instead of wearing apron:
	say "You put the apron on. There seems to be something in it. It feels like a key."
Dish room is a room. Dish room is south of break room. "There is a sink with a lot of dishes in it. They look dirty. It doesn't seem important."
...
Instead of washing dishes:
	say "the sanitizer doesn't seem to be working. The dishes are still dirty."
	
[Fastest way to get through game:
	open fridge and take milk.
	 take espresso beans. 
	grind beans in grinder. 
	use espresso machine with grounds. 
	combine shots with milk. 
	east. 
	north
	east. (break room). 
	take key in apron. 
	west (back storage.) 
	unlock and open cabinet. 
	take pumpkin spice.
	combine pumpkin spice and latte. 
	west
	south
	west
	west
